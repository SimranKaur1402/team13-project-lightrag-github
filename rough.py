...
TXT_FILE = os.path.join(OUTPUT_DIR, "answer.txt")
JSON_FILE = os.path.join(OUTPUT_DIR, "answer.json")

def configure_logging():
    """Sets up clean console logging for LightRAG"""
...
async def main():
    ...
    try:
        ...
        # 3. Define Queries
        queries = [
            "explain diabetes mellitus and give its cures and precautions.",
            "explain machine learning and its types in detail."
        ]
        ...
        for query in queries:
            ...
            for mode in modes:
                ...
                print(f"RESPONSE: {response[:200]}...") # Printing preview to console
